                        ...
                        <div class="col-lg-12">
                            <div class="card mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <a type="button" class="btn btn-primary" href="<?php echo base_url('Pegawai/tambah') ?>">
                                        Tambah Data
                                    </a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                            <a href="<?php echo base_url() . 'Pegawai/edit/' . $kode_pegawai; ?>" class="btn btn-primary" style="color:white; margin-right:5px;"><span class="fa fa-edit"></span></a>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'Pegawai/delete' ?>" method="post">
