                    ...
                    <div class="row">
                        <div class="col-lg-10">
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo base_url() . 'Penggajian/add'; ?>" method="POST">
                                        <div class="row">
                                            <div class="form-group col-md-10">
                                                <label>Nama Pegawai</label>
                                                <select class="select2-single form-control" style="padding: 5px !important; " id="select2Single" name="kode_pegawai" required>
                                                    <option value=""> Pilih</option>
                                                    <?php foreach ($pegawai->result_array() as $row) : ?>
                                                        <option value="<?php echo $row['kode_pegawai'] ?>"><?php echo $row['nama']; ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-top: 10px;">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="cuti" required>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            <div class="col-md-6">
                                                <label>Uang Transport</label>
                                                <input type="number" class="form-control" name="uang_transport" required>
                                            </div>
                                            <div class="col-md-6">
                                                <label>BPJS JHT (Ditanggung Karyawan)</label>
                                                <input type="number" class="form-control" name="potongan_bpjs_jht" required>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" class="form-control" name="potongan_bpjs_kantor" required>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            <div class="col-md-6">
                                                <label>Uang Rajin</label>
                                                <input type="number" class="form-control" name="uang_rajin" required>
                                            </div>
                                        </div>
                                        <div class="row" style="margin-top: 10px;">
                                            <div class="col-md-6">
